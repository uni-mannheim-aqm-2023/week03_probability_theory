...
Last week we talked about violations of the multicollinearity (2) and uncorrelated errors (4) assumption.
...
```{r Heteroscedasticity, fig.keep='last'}
set.seed(20200227) # What is this?
